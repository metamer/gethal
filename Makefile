...
OBJS := $(addprefix $(OBJDIR)/,\
			frontend/ArrayGameMap.o frontend/GameMapEntry.o frontend/UIState.o frontend/GameMessageContainer.o frontend/GameStatusEntry.o frontend/GameNumericStatusEntry.o frontend/GameStatusEntryContainer.o frontend/ColoredString.o frontend/ColoredTextObject.o frontend/ColorMapperUtil.o frontend/InputMapper.o\
